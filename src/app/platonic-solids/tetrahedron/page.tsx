        ...
        <div className="mx-auto max-w-6xl">
          ...
          <Card className="mb-8 border-amber-500/20 bg-gradient-to-br from-blue-950/50 to-indigo-950/50 p-8">
            ...
            <Text className="text-blue-200">
              In the language of sacred geometry, the tetrahedron speaks of{" "}
              <strong>fire and transformation</strong>. With only four faces, it
              represents the minimum number of surfaces needed to enclose space.
              This makes it the foundation of all three-dimensional reality.
            </Text>

            <ul className="mt-4 space-y-2 text-blue-200">
              <li>
                • <strong>Fire and transformation</strong>, the spark of
                creation
              </li>
              <li>
                • <strong>Stability through tension</strong>, like a tripod that
                never wobbles
              </li>
              <li>
                • <strong>The Solar Plexus Chakra</strong>, our center of
                personal power
              </li>
              <li>
                • <strong>The number 4</strong>, representing foundation and
                structure
              </li>
            </ul>
          </Card>
          ...
          <Card className="mb-8 border-amber-500/20 bg-gradient-to-br from-blue-950/50 to-indigo-950/50 p-8">
            ...
            <Text className="mb-4 text-blue-200">
              The tetrahedron embodies the principle of{" "}
              <strong>minimal complexity</strong>. With its 4 faces, 4 vertices,
              and 6 edges, it is the simplest possible polyhedron. Remarkably,
              it is
              <strong> self-dual</strong>—its dual is another tetrahedron,
              rotated inside the original.
            </Text>

            <Text className="text-blue-200">
              Every vertex connects to every other vertex—a complete graph in
              three dimensions. This represents total interconnection, where
              every point relates directly to all others. No simpler structure
              can achieve this.
            </Text>
          </Card>
          ...
          <Card className="border-amber-500/20 bg-gradient-to-br from-blue-950/50 to-indigo-950/50 p-8">
            ...
            <Text className="mb-4 text-blue-200">
              The tetrahedral form appears throughout nature and sacred
              traditions:
            </Text>

            <ul className="space-y-3 text-blue-200">
              <li>
                <strong className="text-amber-300">Chemistry:</strong> The
                carbon atom in methane (CH₄) forms a perfect tetrahedron
              </li>
              <li>
                <strong className="text-amber-300">Crystals:</strong>{" "}
                Diamond&apos;s crystal structure is based on tetrahedral
                geometry
              </li>
              <li>
                <strong className="text-amber-300">Engineering:</strong> The
                pyramid form provides maximum strength with minimum material
              </li>
              <li>
                <strong className="text-amber-300">Symbolism:</strong>{" "}
                Represents the element of fire in Greek philosophy—sharp,
                active, ascending
              </li>
            </ul>
          </Card>
