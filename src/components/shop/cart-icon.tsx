      ...
      <AnimatePresence>
        {hasItems && (
          <motion.span
            ...
            className="absolute -right-0.5 -top-0.5 flex h-5 w-5 items-center justify-center rounded-full bg-[var(--color-gold)] text-xs font-medium text-[var(--color-obsidian)] shadow-[0_0_8px_var(--glow-gold)]"
          >
